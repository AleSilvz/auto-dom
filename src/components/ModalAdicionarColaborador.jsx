...
function ModalAdicionarColaborador({ show, funcModal }) {
  ...
  const camposPreenchidos = (obj) => {
    return Object.values(obj).every((valor) => {
      if (typeof valor === "object") {
        return camposPreenchidos(valor);
      }
      return valor !== "";
    });
  };
    ...
    show && (
      ...
      >
        ...
        >
          ...
          >
            <h3 style={{ fontWeight: "600" }}>Adicionar colaborador</h3>
            <span onClick={() => funcModal()} style={{ cursor: "pointer" }}>
              <IoMdClose size={20} />
            </span>
          </div>
                ...
                {diasSemana.map((e, i) => (
                  <div
                    ...
                    style={{
                      ...
                      cursor: "pointer",
                      border: "1px solid #d4d4d4",
                      backgroundColor: dados.folgaFixa === e ? "#CBDBFC" : "",
                    }}
                    onClick={() => {
                      setDados((prev) => ({
                        ...prev,
